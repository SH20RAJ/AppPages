...
$html = <<<HTML
  <div class="app_list">
  <div class="box_grey"><form action="search/" method="get"><div class="search_field"><input name="q" id="searchinput2" value="$search" type="search"><button type="submit" title="Find">
